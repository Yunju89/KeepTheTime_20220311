...
import org.techtown.keepthetime_20220311.databinding.ActivityEditMyPlaceBinding
    ...
    override fun setupEvents() {
        ...
        binding.btnSave.setOnClickListener {
            ...
            if(mSelectedPoint == null){
                Toast.makeText(mContext, "지도를 클릭해, 장소를 선택해 주세요.", Toast.LENGTH_SHORT).show()
                return@setOnClickListener
            }
            ...
            apiList.postRequestAddMyPlace(
                ...
                override fun onResponse(
                    ...
                    if(response.isSuccessful)
                        Toast.makeText(mContext, "내 출발 장소가 추가되었습니다", Toast.LENGTH_SHORT).show()
                    finish()
                }
    ...
    override fun setValues() {
        ...
        binding.naverMapView.getMapAsync {
            ...
            naverMap.setOnMapClickListener { pointF, latLng ->
                ...
                if(mSelectedPoint==null) {
//                    처음으로 지도를 클릭한 상황.
//                    마커를 새로 만들어주자. => 위치정보는? latLng 변수가 대입될 예정. 새로 만들 필요가 없다.
                    marker = Marker()
